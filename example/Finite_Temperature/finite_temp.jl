...
@doc raw"""
    velocity_integrand_t(velocity::Array{Float64,2},dielectric::Array{Float64,2}, momentum::Float64, cutoff::Float64, phi::Float64, m::Int64, n::Int64, i::Int64, temp::Float64)
...
"""
function velocity_integrand_t(velocity::Array{Float64,2},dielectric::Array{Float64,2}, momentum::Float64, cutoff::Float64, phi::Float64, m::Int64, n::Int64, i::Int64,temp::Float64)
...
@doc raw"""
    dielectric_integrand_t(velocity::Array{Float64,2},dielectric::Array{Float64,2}, momentum::Float64, cutoff::Float64, phi::Float64, m::Int64, n::Int64, i::Int64, temp::Float64)
...
## Args
    ...
    temp     (Float64) : temperature
"""
function dielectric_integrand_t(velocity::Array{Float64,2},dielectric::Array{Float64,2}, momentum::Float64, cutoff::Float64, phi::Float64, m::Int64, n::Int64, i::Int64,temp::Float64)
...
for temp in 0.01:0.01:0.09
    ...
    velocity_integrand(velocity,dielectric,momentum,cutoff,phi,m,n,i) = velocity_integrand_t(velocity,dielectric,momentum,cutoff,phi,m,n,i,temp)
    dielectric_integrand(velocity,dielectric,momentum,cutoff,phi,m,n,i) = dielectric_integrand_t(velocity,dielectric,momentum,cutoff,phi,m,n,i,temp)
